...
At last we export this edgelist to the file *camera_iin_edgelist.csv* and the
feature annotation and quantification table to *camera_iin_quant_table*. These
can be used as input for the Ion Identity Networking (IIN) in GNPS. Note that we
restrict the output to features and edges for which adduct annotations were
defined by CAMERA.
...
write.csv(edgelist_sub, file = "camera_iin_edgelist.csv", row.names = FALSE,
          quote = FALSE, na = "")
write.table(quant_table_sub, file = "camera_iin_quant_table.txt",
