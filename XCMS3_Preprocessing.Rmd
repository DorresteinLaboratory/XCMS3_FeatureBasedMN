...
At last we export this edgelist to the file *camera_edgelist.csv* which can be
used as input in FBMN.

```{r}
write.csv(edgelist, file = "camera_edgelist.csv", row.names = FALSE,
          quote = FALSE, na = "")
```
