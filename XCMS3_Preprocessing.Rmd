...
Create an `xsAnnotate` object and group co-eluted peaks based on their retention
time. For settings see ... or ...
...
TODO:
- check settings, do they ~ fit the data set?
- if there is a way to evaluate settings or display results please add them.
- do a "standard" CAMERA analysis (based e.g. on the code below).
- add some description what each individual step does and eventually some notes
  on the settings (and some potential problems).
